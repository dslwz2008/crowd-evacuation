		...
		if(sameIDs.Count != 0){
			foreach(int id in sameIDs){
				...
				if(status == PeopleStatus.WALK){//walk
					...
					if(goPeople.gameObject.GetComponent<Animation>()){
						goPeople.gameObject.GetComponent<Animation>().wrapMode = WrapMode.Once;
						goPeople.gameObject.GetComponent<Animation>().CrossFade("wanyao");
					}
					...
					if(daodiIDs.Contains(id)){
						...
						if(goPeople.gameObject.GetComponent<Animation>()){
							goPeople.gameObject.GetComponent<Animation>().wrapMode = WrapMode.Once;
							goPeople.gameObject.GetComponent<Animation>().CrossFade("daodi");
							daodiIDs.Add(id);
						}
					}
					...
					if(deadIDs.Contains(id)){
						...
						if(goPeople.gameObject.GetComponent<Animation>()){
							goPeople.gameObject.GetComponent<Animation>().wrapMode = WrapMode.Once;
							goPeople.gameObject.GetComponent<Animation>().CrossFade("dead");
							deadIDs.Add(id);
						}
					}
